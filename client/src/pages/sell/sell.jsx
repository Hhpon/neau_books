      ...
      return (
        ...
        >
          <View className="info-des">
            <Text>价格：</Text>
            <Input
              onBlur={this.nowPriceChange.bind(this, index)}
              className="des"
              type="number"
              placeholder="价格"
            ></Input>
    ...
    return (
      <View className="sell">
        <ScrollView scrollY enableBackToTop className="book-card">
          {BooksList}
          {!booksInfo.length && (
            <View className="nothing-wrapper">您还没扫描任何书籍</View>
          )}
        </ScrollView>
        <View className="scan-code">
          ...
          {booksInfo.length && (
            <View className="putOutWrapper">
              <View>
                {booksInfo.length}本 可卖￥{totalPrice()}
              </View>
              <Button className="putOutBtn" onClick={this.putOutHandle}>
                发布
              </Button>
            </View>
          )}
        ...
        <View className="modal">
          <SeModal
            onCancelModalHandle={this.putOutCancelHandle}
            cancelIsOpen
