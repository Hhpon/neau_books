...
import { HISTORY_STORAGE, LIMIT_COUNT, OPENID_STORAGE } from '@common/js/config.js'
    ...
    return (
      <View className='search'>
        <View className='search-container'>
          ...
          <Input focus value={searchValue} placeholder='搜索书籍名称' className='search-input' onInput={this.onSearchValueChange}></Input>
          {searchValue &&
